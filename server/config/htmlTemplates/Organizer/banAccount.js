/**
 * Email template for when an organizer's account has been permanently banned.
 * This version does not include a specific reason in the email content.
 *
 ...
 */
exports.accountBannedEmailHtml = (organizerName, contactEmail) => {
    return `
...
<head>
    ...
    <title>Urgent: Your Link Hangouts Organizer Account Has Been Permanently Banned</title>
    <style type="text/css">
...
<body style="margin: 0; padding: 0; min-width: 100%; background-color: #f4f4f4;">
    ...
    <span class="preheader" style="color: transparent; display: none !important; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">
        Important and urgent information regarding your Link Hangouts Organizer account.
    </span>
                    ...
                    <tr>
                        <td class="padding-mobile" style="padding: 30px 40px;">
                            ...
                            <p style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; line-height: 1.6; color: #333333; margin: 0 0 20px 0;">
                                This is an urgent notification regarding your Link Hangouts organizer account. We regret to inform you that your account has been **permanently banned** from our platform.
                            </p>

                            <p style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; line-height: 1.6; color: #333333; margin: 0 0 15px 0;">
                                As a result, you will no longer have access to your organizer dashboard, event management tools, or any associated data on Link Hangouts. This action is final.
                            </p>

                            <p style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; line-height: 1.6; color: #333333; margin: 0 0 15px 0;">
                                If you have any questions regarding this decision, please contact our support team at <a href="mailto:${contactEmail}" style="color: #007BFF; text-decoration: none;">${contactEmail}</a>.
                            </p>
