/**
 * Email template for when an organizer's account suspension has been lifted.
 *
 ...
 */
exports.accountResumedEmailHtml = (organizerName, contactEmail) => {
    return `
...
<head>
    ...
    <title>Great News! Your Link Hangouts Organizer Account is Active Again!</title>
    <style type="text/css">
...
<body style="margin: 0; padding: 0; min-width: 100%; background-color: #f4f4f4;">
    ...
    <span class="preheader" style="color: transparent; display: none !important; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">
        Your Link Hangouts Organizer account is now fully active again!
    </span>
                    ...
                    <tr>
                        <td class="padding-mobile" style="padding: 30px 40px;">
                            ...
                            <p style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; line-height: 1.6; color: #333333; margin: 0 0 20px 0;">
                                We are pleased to inform you that the suspension on your Link Hangouts organizer account has been lifted!
                            </p>

                            <p style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; line-height: 1.6; color: #333333; margin: 0 0 15px 0;">
                                Your account is now fully active, and you can resume managing your events and accessing all organizer features.
                            </p>

                            <p style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; line-height: 1.6; color: #333333; margin: 0 0 15px 0;">
                                We appreciate your patience and look forward to your continued use of Link Hangouts.
                            </p>
